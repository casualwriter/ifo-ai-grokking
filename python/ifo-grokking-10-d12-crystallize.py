...
"""
IFO Grokking Experiment V10: Forcing Complete Crystallization on D12
Focus: Pushing train_fraction to 0.7 and steps to 40,000 to see if H1 
       crystallizes when Val Acc reaches ~100%.
...
def run_single_seed_d12(seed, steps=40000, track_interval=800):
...
if __name__ == "__main__":
    ...
    print("Starting D12 Crystallization Experiment (40k steps)...")
    
    for seed in seeds:
        print(f"\n>>> Running D12 Seed {seed}...")
        history = run_single_seed_d12(seed, steps=40000, track_interval=800)
    ...
    ax.set_title('D12 Group (Crystallize): Val Acc')
    ax.legend()
    ...
    plt.tight_layout()
    plt.savefig('ifo-grokking-v10-d12-crystallize.png', dpi=150)
    print("\nD12 crystallization plot saved to: ifo-grokking-v10-d12-crystallize.png")
    plt.show()
